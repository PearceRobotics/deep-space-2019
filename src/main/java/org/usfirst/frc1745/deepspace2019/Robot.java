...
public class Robot extends TimedRobot {
    ...
    private boolean hasBackedOut = false;
    ...
    public void robotInit() {
        ...
        this.hydraulicClimber = new HydraulicClimber(drive);
        ...
        oi = new OI(controls, manipulator, hydraulicClimber);
    ...
    public void autonomousPeriodic() {
        ...
        } else if (!hasBackedOut) {
            if (limelight.getTargetArea() > 10.0 && !isDeployed) {
